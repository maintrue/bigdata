# 1 Flink+MySQL实现End-to-End Exactly-Once
...
创建kafka topic
``` 
/export/servers/kafka_2.12-2.4.1/bin/kafka-topics.sh --zookeeper server1:2181 --create --replication-factor 2 --partitions 3 --topic topic_in
```

开启控制台生产者 
``` 
/export/servers/kafka_2.12-2.4.1/bin/kafka-console-producer.sh --broker-list server1:9092 --topic topic_in
```
