...
* 同一个Cube下不同的Segment除了背后的源数据不同之外，其他如结构定义、构建过程、优化方法、存储方式等都完全相同。
  ...
  | segment示意图                              |
    | ------------------------------------------ |
  | ![1572053960937](assets/1572053960937.png) |
...
| 将日期分区字段添加到维度列中               |
| ------------------------------------------ |
| ![1571993952850](assets/1571993952850.png) |
...
| 在设置中，配置分区列，并指定日期格式       |
| ------------------------------------------ |
| ![1571993995463](assets/1571993995463.png) |
...
| 查看segment                                |
| ------------------------------------------ |
| ![1571995465449](assets/1571995465449.png) |
...
| ------------------------------------------ |
| ![1571995520250](assets/1571995520250.png) |
...
| 查看任务名称                               |
| ------------------------------------------ |
| ![1571995677172](assets/1571995677172.png) |
...
| ------------------------------------------ |
| ![1571995805314](assets/1571995805314.png) |
...
| postman示意图                              |
| ------------------------------------------ |
| ![1571997516925](assets/1571997516925.png) |
