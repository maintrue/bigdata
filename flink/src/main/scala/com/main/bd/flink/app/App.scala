package com.main.bd.flink.app

import java.time.Duration
import java.util.Properties
import java.util.concurrent.TimeUnit
import com.main.bd.flink.app.bean.{ClickLog, ClickLogWide, Message}
import com.main.bd.flink.app.task.{ChannelHotTask, ChannelPvUvTask, DataToWideTask}
